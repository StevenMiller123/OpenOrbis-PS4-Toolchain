...
int32_t sceNpIdMapperAbortRequest(int32_t request_id);
int32_t sceNpIdMapperAccountIdToNpId(int32_t request_id, int32_t user_id, uint64_t account_id_array[], OrbisNpId np_id_array[], int32_t array_length, bool accept_partial_result, int32_t caller);
int32_t sceNpIdMapperAccountIdToOnlineId(int32_t request_id, int32_t user_id, uint64_t account_id_array[], OrbisNpOnlineId online_id_array[], int32_t array_length, bool accept_partial_result, int32_t caller);
int32_t sceNpIdMapperCreateRequest();
int32_t sceNpIdMapperDeleteRequest(int32_t request_id);
int32_t sceNpIdMapperNpIdToAccountId(int32_t request_id, int32_t user_id, OrbisNpId np_id_array[], uint64_t account_id_array[], int32_t array_length, bool accept_partial_result, int32_t caller);
int32_t sceNpIdMapperOnlineIdToAccountId(int32_t request_id, int32_t user_id, OrbisNpOnlineId online_id_array[], uint64_t account_id_array[], int32_t array_length, bool accept_partial_result, int32_t caller);
